...
{
    public class OOF1050MainExecute : CodeActivity
    {
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            dt = new OOF1050BL().LoadData(ASOFTUtilities.GetDataByKey("DivisionID", args), ASOFTUtilities.GetDataByKey("EffectDate", args), ASOFTUtilities.GetDataByKey("ExpiryDate", args), ASOFTUtilities.GetDataByKey("InformType", args), ASOFTUtilities.GetDataByKey("CreateUserID", args), ASOFTUtilities.GetDataByKey("DepartmentID", args), ASOFTUtilities.GetDataByKey("Disabled", args), requestPage, requestPageSize);
