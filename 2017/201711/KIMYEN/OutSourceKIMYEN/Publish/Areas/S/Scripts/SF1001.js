...
function formIsInvalid() {
    return ASOFT.form.checkRequiredAndInList(ID, ['DepartmentID','TeamID']);
}
function combo_Changed() {
    ASOFT.form.checkItemInListFor(this, ID);
}

function comboDepartmentID_Changed() {
    $("#TeamID").data("kendoComboBox").value("");
    $("#TeamID").data("kendoComboBox").dataSource.data([]);
}
...
function combo_TeamData() {
    var data = {};
    data.DepartmentID = $("#DepartmentID").data("kendoComboBox").value();
    return data;
}
//function combo_TeamOpen() {
//    var DepartmentID = $("#DepartmentID").data("kendoComboBox").value();
//    var url = $("#UrlLoadDataTeamID").val();
//    ASOFT.helper.postTypeJson("/S/SF1000/LoadTeamID?DepartmentID=" + DepartmentID, {}, function (result) {
//        $("#DepartmentID").data("kendoComboBox").dataSource.data(result);
//        if (result.length == 0) {
