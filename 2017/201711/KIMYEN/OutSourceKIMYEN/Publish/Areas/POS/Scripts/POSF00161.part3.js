...
(function(){
    $("#TotalAmount, #TotalTaxAmount, #TotalDiscountRate, #TotalDiscountAmount, #TotalRedureRate, #TotalRedureAmount, #PaymentObjectAmount01, #PaymentObjectAmount02, #TotalInventoryAmount, #Change, #BookingAmount").addClass('asf-temporary-disable');
}());
