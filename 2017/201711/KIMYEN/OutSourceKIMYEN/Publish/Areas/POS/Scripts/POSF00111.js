...
var
    ...
    ListChoose = {
        ...
        "IntroduceUser": function (result) {

            $("#IntroduceUserID").val(result["MemberID"]);

            $("#IntroduceUserName").val(result["MemberName"]);
        }
    },
    currentChoose = null;
...
function btnIntroduceUser_click() {

    currentChoose = "IntroduceUser";
    var urlPopup = "/PopupSelectData/Index/POS/POSF00761";
...
function btnIntroduceUserDelete_click() {
    $("#IntroduceUserID").val("");
    $("#IntroduceUserName").val("");
}
...
var POSF00111View = function () {
    ...
    function postData() {
        ...
        data.IsGetCommission = ($("#IsGetCommission").is(":checked"));
    ...
    // Kiểm tra tính hợp lệ của form
    //var formCheckPhone = function () {
    //    if ($("#MemberID").val() == $("#Tel").val())
    //        $("#Tel").addClass("asf-focus-input-error");
    //    if ($("#MemberID").val() == $("#Phone").val())
    //        $("#Phone").addClass("asf-focus-input-error");
    //    return $("#MemberID").val() == $("#Tel").val() || $("#MemberID").val() == $("#Phone").val();
    //}
    ...
    var save = function (url, afterSaveSuccessHandlers) {
        ...
        //if (formCheckPhone())
        //{
        //    ASOFT.form.displayError(FORM_ID, ASOFT.helper.getMessage("00ML000047"));
        //    $("#MemberID").addClass("asf-focus-input-error");
        //    return;
        //}
...
$(document).ready(function () {
    ...
    $("#IntroduceUserName")
        ...
        .parent()
        .append(templeteButton.getAsoftButton("", "btnIntroduceUser", "", "...", "btnIntroduceUser_click()") + templeteButton.getDeleteAsoftButton("btnIntroduceUserDelete", "btnIntroduceUserDelete_click()"));
