...
$(document).ready(function () {
    ...
    $("#OOR").append(tableOO);
    $("#TableOO").append($(".PeopleCreate"));
    $("#OOR").append(kendo.format(DivTag, 'DOther'));

    $('#DPeriod').append(kendo.format(DivTagblock, "left"));
    $('#DPeriod .block-left .asf-filter-label').append($(".ReportCode").children()[0]);
    $('#DPeriod .block-left .asf-filter-input').append($(".ReportCode").children()[0]);
