...
$(document).ready(function () {
    ...
    $('#DPeriod .block-left .asf-filter-label').append($(".ReportCode_AF3001").children()[0]);
    $('#DPeriod .block-left .asf-filter-input').append($(".ReportCode_AF3001").children()[0]);
    ...
    $('#DOther .block-right .asf-filter-label').append($(".DateCreate").children()[0]);
    $('#DOther .block-right .asf-filter-input').append($(".DateCreate").children()[0]);

    var cboReportCode = $("#ReportCode_AF3001").data("kendoComboBox");
    if (cboReportCode) {
