var GridCIF1280 = null;
var urldeleteCIF1280 = null;

$(document).ready(function () {
    urldeleteCIF1280 = $('#DeleteCIF1280').val();
    GridCIF1280 = $("#GridAT1208").data("kendoGrid");
    $("#BtnDelete").unbind();
...
function CustomDelete_Click() {
    ...
    var records = ASOFT.asoftGrid.selectedRecords(GridCIF1280);
    ...
    for (var i = 0; i < records.length; i++) {
        ...
        valuepk = valuepk + "," + records[i]["PaymentTermID"];

        args.push(valuepk);
    }
    key.push(tablecontent, pk);
    ASOFT.dialog.confirmDialog(ASOFT.helper.getMessage('00ML000024'), function () {
        ASOFT.helper.postTypeJson1(urldeleteCIF1280, key, args, deleteSuccess);
    });
}
...
function PrintClick() {
    ...
    ASOFT.helper.postTypeJson1("/CI/CIF1280/DoPrintOrExport", key1, value1, ExportSuccess);
}

function ExportSuccess(result) {
    if (result) {
        var urlPrint = '/CI/CIF1280/ReportViewer';
