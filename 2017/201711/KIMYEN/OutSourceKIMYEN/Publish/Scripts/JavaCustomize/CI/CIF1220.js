var GridCIF1220 = null;
var urldeleteCIF1220 = null;

$(document).ready(function () {
    urldeleteCIF1220 = $('#DeleteCIF1220').val();
    GridCIF1220 = $("#GridAT1003").data("kendoGrid");
    $("#BtnDelete").unbind();
...
function CustomDelete_Click() {
    ...
    var records = ASOFT.asoftGrid.selectedRecords(GridCIF1220);
    ...
    for (var i = 0; i < records.length; i++) {
        ...
        valuepk = valuepk + "," + records[i]["AreaID"];

        args.push(valuepk);
    }
    key.push(tablecontent, pk);
    ASOFT.dialog.confirmDialog(ASOFT.helper.getMessage('00ML000024'), function () {
        ASOFT.helper.postTypeJson1(urldeleteCIF1220, key, args, deleteSuccess);
    });
}
...
function PrintClick() {
    ...
    ASOFT.helper.postTypeJson1("/CI/CIF1220/DoPrintOrExport", key1, value1, ExportSuccess);
}

function ExportSuccess(result) {
    if (result) {
        var urlPrint = '/CI/CIF1220/ReportViewer';
        var urlExcel = '/CI/CIF1220/ExportReport';
