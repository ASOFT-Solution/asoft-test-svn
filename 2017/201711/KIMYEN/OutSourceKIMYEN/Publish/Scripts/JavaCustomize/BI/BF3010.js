...
$(document).ready(function () {
    ...
    $("#btnFromObjectName").kendoButton({"click": SCREENBF3010.btnFromObjectName_Click});
    $("#btnDeleteFromObjectName").kendoButton({ "click": SCREENBF3010.btnDeleteFromObjectName_Click });

    $("#btnToObjectName").kendoButton({ "click": SCREENBF3010.btnToObjectName_Click });
    $("#btnDeleteToObjectName").kendoButton({ "click": SCREENBF3010.btnDeleteToObjectName_Click });

})

SCREENBF3010 = new function () {
    this.ListChoose = {
...
function receiveResult(result) {
    this[SCREENBF3010.ListChoose[currentChoose](result)];
};
