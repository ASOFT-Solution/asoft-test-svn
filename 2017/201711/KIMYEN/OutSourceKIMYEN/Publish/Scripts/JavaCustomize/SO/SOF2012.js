...
/**  
   * Load page
   *
   * [Kieu Nga] Create New [06/12/2017]
   **/
this.SOF2012_Load = function () {
    $("#BtnEdit").unbind('click');
    $("#BtnEdit").bind('click',CheckEdit);
};
...
this.CheckEdit = function () {
    // Kiem tra sua data
    ASOFT.helper.postTypeJson("/SO/SOF2010/CheckEdit?voucherID=" + getUrlParameter("PK"), {}, function (result) {
        if (result) {
            if (result.Status == 3) {
