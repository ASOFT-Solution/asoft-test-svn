...
$(document).ready(function () {
    ...
    GridOT2002.bind("dataBound", function (e) {
        ...
        var TotalFooterDiscountSaleAmountDetail = 0;
        ...
        if (dataSource.length > 0) {
            for (var i = 0; i < dataSource.length; i++) {
                ...
                //TotalFooterDiscountSaleAmountDetail
                TotalFooterDiscountSaleAmountDetail = (dataSource[i].DiscountSaleAmountDetail && dataSource[i].DiscountSaleAmountDetail > 0) ? TotalFooterDiscountSaleAmountDetail + parseFloat(dataSource[i].DiscountSaleAmountDetail) : TotalFooterDiscountSaleAmountDetail + 0;
            }
        }
        //TotalOrderQuantity
        ...
        //TotalFooterDiscountSaleAmountDetail
        $('div#totalFooterDiscountSaleAmountDetail').text(formatDecimal(kendo.parseFloat(TotalFooterDiscountSaleAmountDetail), 1));
