...
$(document).ready(function () {
    ...
    var btnToInventoryID = '<a id="btnToInventoryID" style="z-index:10001; position: absolute; right: 47px; height: 25px ; min-width: 27px;" data-role="button" class="k-button k-button-icontext asf-button" role="button" aria-disabled="false" tabindex="0" onclick="btnFromInventoryID_Click(6)">...</a>';

    var btnDeleteToInventoryID = '<a id="btnDeleteToInventoryID" style="z-index:10001; position: absolute; right: 19px; height: 25px; min-width: 27px; border: 1px solid #dddddd;" data-role="button" class="k-button k-button-icontext  asf-i-delete-32" role="button" aria-disabled="false" tabindex="0" onclick="btnDeleteFromInventoryID_Click(2)"></a>';

    $("#FromInventoryName").attr('disabled', 'disabled');
    $("#ToInventoryName").attr('disabled', 'disabled');
    $("#FromInventoryName").after(btnFromInventoryID);
    $("#FromInventoryName").after(btnDeleteFromInventoryID);
    $("#ToInventoryName").after(btnToInventoryID);
    $("#ToInventoryName").after(btnDeleteToInventoryID);
