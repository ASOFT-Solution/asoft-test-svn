...
$(document).ready(function () {
    ...
    if (PeriodPopup != undefined) {
        PeriodPopup.bind("refresh", function () {
            comboDivisionID = ASOFT.asoftComboBox.castName("DivisionIDPeriod");
...
function divisionIDChanged(e) {
    ...
    var comboShopId = $("#PeriodShopID").data("kendoComboBox");
...
function periodChanged(e) {
    ...
    var data = {
        DivisionIDPeriod: comboDivisionID.value(),
...
function periodData() {
    ...
    if (comboDivisionID != undefined) {
        data = { DivisionIDPeriod: comboDivisionID.value() };
    }
    return data;
}
...
function bindShopDataSource() {
    var comboDivision = $("#DivisionIDPeriod").data("kendoComboBox")
    if (comboDivision) {
