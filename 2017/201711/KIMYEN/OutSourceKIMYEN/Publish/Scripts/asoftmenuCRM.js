...
$(document).ready(function () {
   ...
   // else {
        ...
        for (var j = 3; j < $("#countLevelMenu").val() ; j++) {
            ...
            $("#MenuPopup_win" + j).mouseleave(function (e) {
                CloseWindowMenuN(j - 1);
            });
        }
...
function btnWarehouse_Click() {
    localStorage.setItem("OpenWare", "true");
    window.location.href = "/POS/POSF0015";
}

function btnExWarehouse_Click() {
    localStorage.setItem("OpenExWare", "true");
    window.location.href = "/POS/POSF0027";
}
