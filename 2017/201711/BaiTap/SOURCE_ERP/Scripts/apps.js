(function ($, window) {
    ...
    Application = {
        ...
        unload: function () {
            ...
            if (!$("#contentMaster").find("[data-role=droptargetarea]").length) {
                kendo.destroy("#contentMaster");
            }
        ...
        replaceTheme: function (themeName) {
            ...
            $("#contentMaster").trigger("kendo:skinChange");
        },
