...
$(document).ready(function () {
    ...
    GridOOT2000 = $("#GridEditOOT2000").data("kendoGrid");
    GridOOT2000.hideColumn("APK");
    ...
    if ($("#StatusOOT9001").val() != 1) {
        setTimeout(function () {
            var input = $("#GridEditOOT2000").find("input[type='checkbox']");
            $(input).each(function () {
    ...
    GridOOT2000.unbind("dataBound");
    var columns = GridOOT2000.columns;
    var name = 'GridEditOOT2000';
    $(GridOOT2000.tbody).off("keydown mouseleave", "td").on("keydown mouseleave", "td", function (e) {
        ...
        var isDefaultLR = $(GridOOT2000.element).attr('isDefaultLR');
        if (editor != undefined) {
            var elm = $(this);
            if (e.shiftKey) {
                switch (e.keyCode) {
...
function StatusChange() {
    GridOOT2000 = $('#GridEditOOT2000').data('kendoGrid');
    var data = GridOOT2000.dataSource.data();
    var totalNumber = data.length;

    if ($("#StatusOOT9001").val() == 1) {
        var input = $("#GridEditOOT2000").find("input#CbGridEdit_Status[type='checkbox']");
        $(input).each(function () {
...
function CustomerCheck() {
    if ($("#StatusOOT9001").val() == 0)
    {
        ...
        ASOFT.form.displayError("#OOF2051", msg);
        return true;
    }
    return false;
}
