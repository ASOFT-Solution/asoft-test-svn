...
$(document).ready(function () {
    ...
    GridOOT2010 = $("#GridEditOOT2010").data("kendoGrid");
    GridOOT2010.hideColumn("APK");
    if ($("#IsLock").val() == "1") {
        $("#BtnSave").kendoButton({
            enable: false
        });
    ...
    //    setTimeout(function () {
    //        var input = $("#GridEditOOT2010").find("input[type='checkbox']");
    //        $(input).each(function () {
    ...
    GridOOT2010.unbind("dataBound");    
    var columns = GridOOT2010.columns;
    var name = 'GridEditOOT2010';
    $(GridOOT2010.tbody).off("keydown mouseleave", "td").on("keydown mouseleave", "td", function (e) {
        ...
        var isDefaultLR = $(GridOOT2010.element).attr('isDefaultLR');
        if (editor != undefined) {
            var elm = $(this);
            if (e.shiftKey) {
                switch (e.keyCode) {
...
function StatusChange() {
    GridOOT2010 = $('#GridEditOOT2010').data("kendoGrid");
    var data = GridOOT2010.dataSource.data();
    var totalNumber = data.length;
   
    if ($("#StatusOOT9001").val() == 1)
    {
        var input = $("#GridEditOOT2010").find("input#CbGridEdit_Status[type='checkbox']");
        $(input).each(function () {
...
function CustomerCheck() {
    if ($("#StatusOOT9001").val() == 0) {
        ...
        ASOFT.form.displayError("#OOF2052", msg);
        return true;
    }
    return false;
}
