var GridCIF1130 = null;
var urldeleteCIF1130 = null;

$(document).ready(function () {
    urldeleteCIF1130 = $('#DeleteCIF1130').val();
    GridCIF1130 = $("#GridAT1301").data("kendoGrid");
    $("#BtnDelete").unbind();
...
function CustomDelete_Click() {
    ...
    var records = ASOFT.asoftGrid.selectedRecords(GridCIF1130);
    ...
    for (var i = 0; i < records.length; i++) {
        ...
        valuepk = valuepk + "," + records[i]["InventoryTypeID"];

        args.push(valuepk);
    }
    key.push(tablecontent, pk);
    ASOFT.dialog.confirmDialog(ASOFT.helper.getMessage('00ML000024'), function () {
        ASOFT.helper.postTypeJson1(urldeleteCIF1130, key, args, deleteSuccess);
    });
}
...
function PrintClick() {
    ...
    ASOFT.helper.postTypeJson1("/CI/CIF1130/DoPrintOrExport", key1, value1, ExportSuccess);
}

function ExportSuccess(result) {
    if (result) {
        var urlPrint = '/CI/CIF1130/ReportViewer';
