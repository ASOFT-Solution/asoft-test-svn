var GridCIF1260 = null;
var urldeleteCIF1260 = null;

$(document).ready(function () {
    urldeleteCIF1260 = $('#DeleteCIF1260').val();
    GridCIF1260 = $("#GridCIT0108").data("kendoGrid");
    $("#BtnDelete").unbind();
...
function CustomDelete_Click() {
    ...
    var records = ASOFT.asoftGrid.selectedRecords(GridCIF1260);
    ...
    ASOFT.dialog.confirmDialog(ASOFT.helper.getMessage('00ML000024'), function () {
        ASOFT.helper.postTypeJson1(urldeleteCIF1260, key, args, deleteSuccess);
    });
}
...
function PrintClick() {
    ...
    ASOFT.helper.postTypeJson1("/CI/CIF1260/DoPrintOrExport", key1, value1, ExportSuccess);
}
