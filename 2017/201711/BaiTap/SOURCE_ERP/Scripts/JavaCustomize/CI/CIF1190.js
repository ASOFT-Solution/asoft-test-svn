var GridCIF1190 = null;
var urldeleteCIF1190 = null;

$(document).ready(function () {
    urldeleteCIF1190 = $('#DeleteCIF1190').val();
    GridCIF1190 = $("#GridAT1004").data("kendoGrid");
    $("#BtnDelete").unbind();
...
function CustomDelete_Click() {
    ...
    var records = ASOFT.asoftGrid.selectedRecords(GridCIF1190);
    ...
    for (var i = 0; i < records.length; i++) {
        ...
        valuepk = valuepk + "," + records[i]["CurrencyID"];

        args.push(valuepk);
    }
    key.push(tablecontent, pk);
    ASOFT.dialog.confirmDialog(ASOFT.helper.getMessage('00ML000024'), function () {
        ASOFT.helper.postTypeJson1(urldeleteCIF1190, key, args, deleteSuccess);
    });
}
...
function PrintClick() {
    ...
    ASOFT.helper.postTypeJson1("/CI/CIF1190/DoPrintOrExport", key1, value1, ExportSuccess);
}

function ExportSuccess(result) {
    if (result) {
        var urlPrint = '/CI/CIF1190/ReportViewer';
