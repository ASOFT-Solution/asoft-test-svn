var GridCIF1110 = null;
var urldeleteCIF1110 = null;

$(document).ready(function () {
    urldeleteCIF1110 = $('#DeleteCIF1110').val();
    GridCIF1110 = $("#GridAT1205").data("kendoGrid");
    $("#BtnDelete").unbind();
...
function CustomDelete_Click() {
    ...
    var records = ASOFT.asoftGrid.selectedRecords(GridCIF1110);
    ...
    for (var i = 0; i < records.length; i++) {
        ...
        valuepk = valuepk + "," + records[i]["PaymentID"];
        args.push(valuepk);
    }
    key.push(tablecontent, pk);
    ASOFT.dialog.confirmDialog(ASOFT.helper.getMessage('00ML000024'), function () {
        ASOFT.helper.postTypeJson1(urldeleteCIF1110, key, args, deleteSuccess);
    });
}
...
function PrintClick() {
    ...
    ASOFT.helper.postTypeJson1("/CI/CIF1110/DoPrintOrExport", key1, value1, ExportSuccess);
}

function ExportSuccess(result) {
    if (result) {
        var urlPrint = '/CI/CIF1110/ReportViewer';
