...
ASOFT.GridScreen = function () {
        ...
        leftToolbar = {
            ...
            btnPrint: {
                ...
                onClick: function (e) {
                    ...
                    ASOFT.helper.postTypeJson("/POS/POSF0043/DoPrintOrExport", datamaster, ExportSuccess);
                }
            },
        },
    ...
    function formFilterData() {
        ...
        if (hasPeriod) {
            fromPeriod = $('#FromPeriodFilter').data('kendoComboBox').dataItem();
...
function refreshGridParent() {
    $("#POSF0043Grid").data('kendoGrid').dataSource.page(1);
}
