...
function createViewModel() {
    ...
    posViewModel = kendo.observable({
        ...
        isDataChanged: function () {
            ...
            var equal = (dataPost.VoucherDate.valueOf() == this.defaultViewModel.VoucherDate.valueOf())
                && (dataPost.VoucherNo.valueOf() == this.defaultViewModel.VoucherNo.valueOf())
                && ((dataPost.EmployeeName.valueOf() == this.defaultViewModel.EmployeeName.valueOf())
                    || (dataPost.EmployeeID.valueOf() == this.defaultViewModel.EmployeeName.valueOf()))
                && (dataPost.Description.valueOf() == this.defaultViewModel.Description.valueOf());
            //debugger
        ...
        getInfo: function () {
            ...
            var selectedItem = $('#EmployeeName').data('kendoComboBox').dataItem()
            if (selectedItem) {
        ...
        isInvalid: function () {
            ...
            var check = ASOFT.form.checkRequiredAndInList(FORM_NAME, ['EmployeeName']);
            if (!check) {
