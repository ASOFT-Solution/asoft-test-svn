...
ASOFT.GridScreen = function () {
        ...
        leftToolbar = {
            ...
            btnImport: {
                ...
                onClick: function (e) {
                    ...
                    var urlImport = ["/Import/ImportDynamic?area=", moduleId, "&id=", screenId, "&table=", table].join("");
    ...
    function handleLeftToolbar(options) {
        ...
        btnImport = options.leftToolbar.btnImport.jqObject
            || $("#" + options.leftToolbar.btnImport.id)
            || leftToolbar.btnImport.jqObject;

        if (btnImport && btnImport.data("kendoButton")) {
            leftToolbar.btnImport.jqObject = btnImport.prop("enable", btnImport.data("kendoButton").options.enable);
        }
