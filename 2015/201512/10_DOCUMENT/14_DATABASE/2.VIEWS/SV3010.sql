...
CREATE VIEW SV3010		
AS		
SELECT	CONVERT(nvarchar(3),'') AS DivisionID,	
	...
	CONVERT(decimal(38,8),0) AS BeginOriginalAmount,	
	CONVERT(decimal(38,8),0) AS BeginConvertedAmount,	
	CONVERT(decimal(38,8),0) AS ReceivedAmount,	
