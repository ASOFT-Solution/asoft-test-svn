...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[MP7729]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[MP7729]
GO
...
----- purpose: Phan bo CP SXC cho TP theo PP dinh muc  & SPDD khong phan bo chi phi

/**********************************************
** Edited by: [GS] [Cẩm Loan] [03/08/2010]
***********************************************/

CREATE PROCEDURE  [dbo].[MP7729] 	@DivisionID as nvarchar(50), 
