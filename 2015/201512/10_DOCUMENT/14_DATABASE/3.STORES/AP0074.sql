...
IF EXISTS (SELECT 1 FROM AT0000 WHERE DefDivisionID = @DivisionID AND IsSpecificate = 1)
	...
	SELECT AT9000.VoucherID,AT9000.BatchID,AT9000.TransactionID,AT9000.TableID,AT9000.DivisionID,AT9000.TranMonth,AT9000.TranYear,AT9000.TransactionTypeID,AT9000.CurrencyID,
		...
		AT1302.IsLocation,AT1302.IsStocked,AT1302.AccountID AS IsDebitAccountID,AT1302.Barcode,AT1302.MethodID,'' AS InventoryName1,CAST(0 AS DECIMAL) AS ConversionFactor,
	...
	FROM AT9000 LEFT JOIN AT1302 ON AT9000.DivisionID = AT1302.DivisionID AND AT9000.InventoryID = AT1302.InventoryID
		Left join WQ1309 On AT9000.DivisionID = WQ1309.DivisionID And AT9000.InventoryID = WQ1309.InventoryID
