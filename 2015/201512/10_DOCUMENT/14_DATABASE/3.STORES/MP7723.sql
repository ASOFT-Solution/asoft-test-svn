...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[MP7723]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[MP7723]
GO
...
----- purpose: Phan bo CP SXC cho  TP & SPDD theo PP dinh muc 

/**********************************************
** Edited by: [GS] [Cẩm Loan] [03/08/2010]
***********************************************/

CREATE PROCEDURE  [dbo].[MP7723] 	@DivisionID as nvarchar(50), 
