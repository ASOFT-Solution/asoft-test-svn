...
SET @sSQL2 = ' 		
	FROM AV7402_ST D3 
		INNER JOIN '+ @TableDBO +'AT1202 Object  on  Object.ObjectID = D3.ObjectID AND Object.DivisionID = D3.DivisionID
		LEFT JOIN '+ @TableDBO +'AT1015 O1 on O1.AnaID = Object.O01ID AND O1.DivisionID = Object.DivisionID AND O1.AnaTypeID = ''O01''
		LEFT JOIN '+ @TableDBO +'AT1015 O2 on O2.AnaID = Object.O02ID AND O2.DivisionID = Object.DivisionID AND O2.AnaTypeID = ''O02''
		LEFT JOIN '+ @TableDBO +'AT1015 O3 on O3.AnaID = Object.O03ID AND O3.DivisionID = Object.DivisionID AND O3.AnaTypeID = ''O03''
		LEFT JOIN '+ @TableDBO +'AT1015 O4 on O4.AnaID = Object.O04ID AND O4.DivisionID = Object.DivisionID AND O4.AnaTypeID = ''O04''
		LEFT JOIN '+ @TableDBO +'AT1015 O5 on O5.AnaID = Object.O05ID AND O5.DivisionID = Object.DivisionID AND O5.AnaTypeID = ''O05''
		LEFT JOIN '+ @TableDBO +'AT1207 OS1 on OS1.S = Object.S1 AND OS1.DivisionID = Object.DivisionID AND OS1.STypeID = ''O01''
		LEFT JOIN '+ @TableDBO +'AT1207 OS2 on OS2.S = Object.S2 AND OS2.DivisionID = Object.DivisionID AND OS2.STypeID = ''O02''
		LEFT JOIN '+ @TableDBO +'AT1207 OS3 on OS3.S = Object.S3 AND OS3.DivisionID = Object.DivisionID AND OS3.STypeID = ''O03''
		INNER JOIN '+ @TableDBO +'AT1005 AS Account on Account.AccountID = D3.AccountID AND Account.DivisionID = D3.DivisionID
...
SET @sSQL2 = ' 	
	FROM AV7402_ST D3 	
		...
		LEFT JOIN '+ @TableDBO +'AT1207 OS2 on OS2.S = Object.S2 AND OS2.DivisionID = Object.DivisionID AND OS2.STypeID = ''O02''
		LEFT JOIN '+ @TableDBO +'AT1207 OS3 on OS3.S = Object.S3 AND OS3.DivisionID = Object.DivisionID AND OS3.STypeID = ''O03''
		INNER JOIN '+ @TableDBO +'AT1005 Account on Account.AccountID = D3.AccountID AND Account.DivisionID = D3.DivisionID
